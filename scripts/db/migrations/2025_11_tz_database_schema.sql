-- =============================================
-- БАЗА ДАННЫХ ТЕХНИЧЕСКИХ ЗАДАНИЙ ДЛЯ СИСТЕМЫ CRD12
-- Создано: 2025-11-06 12:57:59
-- Версия: 1.0
-- Критические правила: 
--   1. Статусы - строго из словаря
--   2. TZ обязательно ссылается на задачу Roadmap
-- =============================================
...
-- Предоставляем права для компонентов системы
GRANT SELECT, INSERT, UPDATE ON eng_it.technical_specifications TO engineer_b_api;
GRANT SELECT, INSERT, UPDATE ON eng_it.roadmap_tz_mapping TO engineer_b_api;
GRANT SELECT, INSERT, UPDATE ON eng_it.kurator_verifications TO engineer_b_api;
GRANT SELECT, INSERT ON eng_it.tz_change_history TO engineer_b_api;

GRANT SELECT ON eng_it.vw_technical_specifications_full TO bot_orchestrator;
GRANT SELECT ON eng_it.vw_tz_statistics TO navigator;
